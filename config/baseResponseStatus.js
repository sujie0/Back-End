module.exports ={
    ...
    //Request error-2000번대
        //스케줄 입력 오류/2000번대
    SCHEDULE_TITLE_EMPTY : { "isSuccess": false, "code": 2001, "message":"일정 제목을 입력해주세요." },
    SCHEDULE_STARTYMD_EMPTY : { "isSuccess": false, "code": 2002, "message":"시작 날짜를 입력해주세요." },
    SCHEDULE_ENDYMD_EMPTY : { "isSuccess": false, "code": 2003, "message":"종료 날짜를 입력해주세요." },
...
/*  SIGNUP_USERID_EMPTY : { "isSuccess": false, "code": 2101, "message":"아이디를 입력해주세요" },
    ...
    SIGNUP_REDUNDANT_USERID : { "isSuccess": false, "code": 3002, "message":"이미 사용중인 아이디입니다." },
        //로그인
